...
#ifndef YARP_CONTROL_MSGS__MSG__DETAIL__POSITION__FUNCTIONS_H_
#define YARP_CONTROL_MSGS__MSG__DETAIL__POSITION__FUNCTIONS_H_
 ...
 * calls
 * yarp_control_msgs__msg__Position__init().
...
/**
 * It calls
 * yarp_control_msgs__msg__Position__fini()
 ...
 * yarp_control_msgs__msg__Position__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yarp_control_msgs__msg__Position__Sequence__fini()
 * on the array,
...
#endif  // YARP_CONTROL_MSGS__MSG__DETAIL__POSITION__FUNCTIONS_H_
