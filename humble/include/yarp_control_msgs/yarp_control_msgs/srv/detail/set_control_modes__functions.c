...
yarp_control_msgs__srv__SetControlModes_Request__init(yarp_control_msgs__srv__SetControlModes_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->names, 0)) {
    yarp_control_msgs__srv__SetControlModes_Request__fini(msg);
    return false;
  }
  // modes
...
yarp_control_msgs__srv__SetControlModes_Request__create()
{
  ...
  yarp_control_msgs__srv__SetControlModes_Request * msg = (yarp_control_msgs__srv__SetControlModes_Request *)allocator.allocate(sizeof(yarp_control_msgs__srv__SetControlModes_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(yarp_control_msgs__srv__SetControlModes_Request));
  bool success = yarp_control_msgs__srv__SetControlModes_Request__init(msg);
  if (!success) {
...
yarp_control_msgs__srv__SetControlModes_Request__Sequence__init(yarp_control_msgs__srv__SetControlModes_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yarp_control_msgs__srv__SetControlModes_Request * data = NULL;

  if (size) {
    data = (yarp_control_msgs__srv__SetControlModes_Request *)allocator.zero_allocate(size, sizeof(yarp_control_msgs__srv__SetControlModes_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = yarp_control_msgs__srv__SetControlModes_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        yarp_control_msgs__srv__SetControlModes_Request__fini(&data[i - 1]);
      }
...
yarp_control_msgs__srv__SetControlModes_Request__Sequence__fini(yarp_control_msgs__srv__SetControlModes_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      yarp_control_msgs__srv__SetControlModes_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yarp_control_msgs__srv__SetControlModes_Request__Sequence * array = (yarp_control_msgs__srv__SetControlModes_Request__Sequence *)allocator.allocate(sizeof(yarp_control_msgs__srv__SetControlModes_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = yarp_control_msgs__srv__SetControlModes_Request__Sequence__init(array, size);
  if (!success) {
...
yarp_control_msgs__srv__SetControlModes_Request__Sequence__destroy(yarp_control_msgs__srv__SetControlModes_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    yarp_control_msgs__srv__SetControlModes_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
yarp_control_msgs__srv__SetControlModes_Request__Sequence__are_equal(const yarp_control_msgs__srv__SetControlModes_Request__Sequence * lhs, const yarp_control_msgs__srv__SetControlModes_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!yarp_control_msgs__srv__SetControlModes_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  yarp_control_msgs__srv__SetControlModes_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(yarp_control_msgs__srv__SetControlModes_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    yarp_control_msgs__srv__SetControlModes_Request * data =
      (yarp_control_msgs__srv__SetControlModes_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yarp_control_msgs__srv__SetControlModes_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          yarp_control_msgs__srv__SetControlModes_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!yarp_control_msgs__srv__SetControlModes_Request__copy(
...
yarp_control_msgs__srv__SetControlModes_Response__init(yarp_control_msgs__srv__SetControlModes_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->response)) {
    yarp_control_msgs__srv__SetControlModes_Response__fini(msg);
    return false;
  }
  {
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yarp_control_msgs__srv__SetControlModes_Response * msg = (yarp_control_msgs__srv__SetControlModes_Response *)allocator.allocate(sizeof(yarp_control_msgs__srv__SetControlModes_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(yarp_control_msgs__srv__SetControlModes_Response));
  bool success = yarp_control_msgs__srv__SetControlModes_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
yarp_control_msgs__srv__SetControlModes_Response__Sequence__init(yarp_control_msgs__srv__SetControlModes_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yarp_control_msgs__srv__SetControlModes_Response * data = NULL;

  if (size) {
    data = (yarp_control_msgs__srv__SetControlModes_Response *)allocator.zero_allocate(size, sizeof(yarp_control_msgs__srv__SetControlModes_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = yarp_control_msgs__srv__SetControlModes_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        yarp_control_msgs__srv__SetControlModes_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
yarp_control_msgs__srv__SetControlModes_Response__Sequence__fini(yarp_control_msgs__srv__SetControlModes_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      yarp_control_msgs__srv__SetControlModes_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yarp_control_msgs__srv__SetControlModes_Response__Sequence * array = (yarp_control_msgs__srv__SetControlModes_Response__Sequence *)allocator.allocate(sizeof(yarp_control_msgs__srv__SetControlModes_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = yarp_control_msgs__srv__SetControlModes_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
yarp_control_msgs__srv__SetControlModes_Response__Sequence__destroy(yarp_control_msgs__srv__SetControlModes_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    yarp_control_msgs__srv__SetControlModes_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
yarp_control_msgs__srv__SetControlModes_Response__Sequence__are_equal(const yarp_control_msgs__srv__SetControlModes_Response__Sequence * lhs, const yarp_control_msgs__srv__SetControlModes_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!yarp_control_msgs__srv__SetControlModes_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  yarp_control_msgs__srv__SetControlModes_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(yarp_control_msgs__srv__SetControlModes_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    yarp_control_msgs__srv__SetControlModes_Response * data =
      (yarp_control_msgs__srv__SetControlModes_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yarp_control_msgs__srv__SetControlModes_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          yarp_control_msgs__srv__SetControlModes_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!yarp_control_msgs__srv__SetControlModes_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
