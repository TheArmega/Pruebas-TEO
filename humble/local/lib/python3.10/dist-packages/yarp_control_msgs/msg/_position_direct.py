...
class Metaclass_PositionDirect(type):
    """Metaclass of message 'PositionDirect'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'yarp_control_msgs.msg.PositionDirect')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__position_direct
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__position_direct
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__position_direct
            cls._TYPE_SUPPORT = module.type_support_msg__msg__position_direct
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__position_direct
...
class PositionDirect(metaclass=Metaclass_PositionDirect):
    """Message class 'PositionDirect'."""
