...
bool yarp_control_msgs__msg__position_direct__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yarp_control_msgs.msg._position_direct.PositionDirect", full_classname_dest, 53) == 0);
  }
  yarp_control_msgs__msg__PositionDirect * ros_message = _ros_message;
  {  // names
...
{
  /* NOTE(esteve): Call constructor of PositionDirect */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yarp_control_msgs.msg._position_direct");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PositionDirect");
