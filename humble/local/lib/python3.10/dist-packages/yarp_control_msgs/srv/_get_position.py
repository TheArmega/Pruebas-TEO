...
class GetPosition_Response(metaclass=Metaclass_GetPosition_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.response = kwargs.get(
            'response', GetPosition_Response.RESPONSE__DEFAULT)
...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'yarp_control_msgs.srv.GetPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from yarp_control_msgs.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from yarp_control_msgs.srv._get_position import GetPosition_Request as Request
    from yarp_control_msgs.srv._get_position import GetPosition_Response as Response
